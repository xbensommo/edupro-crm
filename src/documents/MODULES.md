...
# Module Documentation: EduPro CRM System

## 📦 Module Overview

This document provides detailed documentation for all installed modules in the EduPro CRM System application. Each module is a self-contained business capability with its own UI, logic, and data structures.
