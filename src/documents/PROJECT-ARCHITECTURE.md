...
# Project Architecture: EduPro CRM System

## 🏗️ Overview

This document describes the architectural decisions, patterns, and structure of the EduPro CRM System application. The application follows a modular, feature-based architecture that promotes separation of concerns, reusability, and maintainability.
...
```javascript
// .env.production
VITE_API_URL=https://api.edupro-crm.com
