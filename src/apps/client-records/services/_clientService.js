...
export function createClientService({
  ...
  function normalizeClientPayload(payload = {}) {
    ...
    return {
      ...
      // assignedTo: payload.assignedTo || currentUser?.uid || null, for client-activities
  ...
  async function fetchClients(options = {}) {
    ...
    await clientsActions.fetchInitialPage(options)
  ...
  async function createClient(payload = {}) {
    ...
    const {id} = await clientsActions.add(client)
