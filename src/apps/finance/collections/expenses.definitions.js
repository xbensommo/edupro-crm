/**
 * @file src/apps/finance/collections/expenses.definitions.js
...
export default defineCollection({
  name: 'expenses',
  shard: { type: 'none', field: 'expenseDate' },
  schema: {
    expenseCode: { type: FIELD_TYPES.STRING, required: true, immutable: true, searchable: true, sortable: true, filterable: true },
  ...
  primaryKey: { field: 'expenseCode', required: true },
  indexes: [
    { fields: ['expenseDate'], order: 'ASCENDING' },
    { fields: ['isDeleted', 'expenseDate'], order: 'ASCENDING' },
    { fields: ['expenseCode'], order: 'ASCENDING' },
    { fields: ['category', 'expenseDate'], order: 'ASCENDING' },
    { fields: ['status', 'expenseDate'], order: 'ASCENDING' },
    { fields: ['relatedUserId', 'expenseDate'], order: 'ASCENDING' },
    { fields: ['relatedEngagementId', 'expenseDate'], order: 'ASCENDING' },
  ],
  search: {
    mode: 'token-array',
