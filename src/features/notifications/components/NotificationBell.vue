...
<template>
  <button
    type="button"
    class="notification-bell inline-flex items-center gap-2 rounded-full border px-3 py-2 text-sm font-semibold transition hover:-translate-y-0.5"
  ...
  >
    <span class="relative inline-flex h-5 w-5 items-center justify-center">
      ...
      <span
        v-if="unreadCount"
        class="badge absolute -right-2 -top-2 inline-flex min-h-5 min-w-5 items-center justify-center rounded-full px-1 text-[11px] font-bold"
      >
